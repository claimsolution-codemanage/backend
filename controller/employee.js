...
import { validateEmployeeSignIn, validateEmployeeResetPassword, validateAddPartner, validateAddEmpCase, validateSathiTeamSignUp, validateEmployeeUpdate } from "../utils/validateEmployee.js";
import { validMongooseId, getAllCaseQuery, getAllPartnerSearchQuery, generatePassword, getDownloadCaseExcel, getAllPartnerDownloadExcel, getAllEmployeeSearchQuery, getValidateDate, getEmployeeByIdQuery, getAllSathiDownloadExcel, getAllClientDownloadExcel, getAllStatementDownloadExcel, commonDownloadCaseExcel, getAllClientResult, getAllPartnerResult, getAllCaseDocQuery } from "../utils/helper.js";
import { sendAddClientRequest, sendEmployeeSigninMail, sendForgetPasswordMail, sendMail } from "../utils/sendMail.js";
import { validateClientProfileBody } from "../utils/validateClient.js";
...
import { firebaseUpload, validateResetPassword } from "../utils/helper.js";
...
export const salesDownloadCaseReport = async (req, res) => {
   try {
      const { employee } = req
      let { search = "", status = "", startDate = "", endDate = "", empId = "", isReject = "", isWeeklyFollowUp = false, isClosed = false } = req.query
      const caseAccess = ["operation", "finance", "branch"]
