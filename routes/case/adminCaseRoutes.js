...
router.get("/viewCaseDocsById/:_id", adminCaseController.viewCaseDocsById)
router.get("/viewCaseProcessStepsById/:_id", adminCaseController.viewCaseProcessStepsById)
